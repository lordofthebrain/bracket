...
async def sql_update_match(match_id: MatchId, match: MatchBody, tournament: Tournament) -> None:
    query = """
        ...
        SET round_id = :round_id,
            ...
            stage_item_input1_score_extra_time_half = :stage_item_input1_score_extra_time_half,
            stage_item_input2_score_extra_time_half = :stage_item_input2_score_extra_time_half,
            stage_item_input1_score_after_extra_time = :stage_item_input1_score_after_extra_time,
            stage_item_input2_score_after_extra_time = :stage_item_input2_score_after_extra_time,
            stage_item_input1_score_penalties = :stage_item_input1_score_penalties,
            stage_item_input2_score_penalties = :stage_item_input2_score_penalties,
            is_played = :is_played,
            court_id = :court_id,
